        ...
        <div class="col-md-12 content-case mt-4 mb-4">
            <div class="row no-gutters">
                ...
                <div class="col-md-12 col-lg-6" style="padding:2rem">
                    <div class="heading">
                        <h2>God kundeservice</h2>
                    </div>
                    <p>Sosiale og mobile løsninger har endret kundenes krav til service. De forventer kvalitet og tilpasset service – på sine vilkår – for nettsider, sosiale- og mobile løsninger, samt telefon.
Med Microsoft Dynamics CRM kan du knytte langvarige kunderelasjoner ved å tilby korrekt og tilpasset kundeservice – når som helst, i alle kanaler. Sørg for at dine ansatte har alt de trenger for å kunne yte god kundeservice.</p>
        ...
        <div class="col-md-12 content-case mt-4 mb-4">
            <div class="row no-gutters">
                <div class="col-md-12 col-lg-6" style="padding:2rem">
                    <div class="heading">
                        <h2>Smartere markedsføring</h2>
                    </div>
                    <p>Markedsføring er i endring som aldri før. Markedsførere eier mer av kundereisen og må engasjere kundene på nye måter og i nye kanaler for å kunne levere gode opplevelser. Samtidig må de kunne spore resultatene av markedsføringskronene.</p>
                    <p>Microsoft Dynamics Marketing hjelper deg med å utnytte ditt markedsføringspotensial. Du kan enkelt planlegge, kjøre og måle kampanjer fra start til mål. Realiser markedsføringsvisjonen – engasjer kunder i alle kanaler, bygg informasjonskanaler og vis effekten av markedsføringen..</p>
